# Curso_JavaScript_TypeScript.V2
Front-end e Back-end (Full Stack) - Node, Express, noSQL, React, hooks, Redux, Design Patterns
## Instrutores:
- Luiz Otávio Miranda - Instrutor - Desenvolvedor de Softwares
- Tales Calogi Malaquias - Instrutor


## Anotações e explicações
Acesse por [aqui](https://coral-address-f67.notion.site/Javascript-e-TypeScript-front-end-e-back-end-e88f6b3e06094b57b1bf883d7183aad2)
